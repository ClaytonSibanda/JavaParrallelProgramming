...
public class MainParrallel {
    ...
    public static void main(String args[]) {
        ...
        for (int size = 3; size <= 21; size += 2) {
            for (length = 100000; length <= 1000000; length += 100000) {
                ...
                Experiment.writeCSV("C:\\Users\\USER\\Desktop\\2nd year\\2nd Semester\\CSC2002S\\Assignments\\Assignment1\\outputSEQUENTIAL_CUTOFFAll.csv", Experiment.cut_Off(), length, size, timeArr);
